...
class CityWeatherRepository extends ServiceEntityRepository
{
    ...
    public function save(CityWeather $entity, bool $flush = false): void
    {
    ...
    public function remove(CityWeather $entity, bool $flush = false): void
    {
...
//    public function findOneBySomeField($value): ?CityWeather
//    {
//        return $this->createQueryBuilder('c')
//            ->andWhere('c.exampleField = :val')
//            ->setParameter('val', $value)
